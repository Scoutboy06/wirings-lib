...
export const tokyonightNightTheme: Theme = {
	...
	userInputBit: {
		inactiveFill: tokyonightNightPalette.red,
		inactiveStroke: tokyonightNightPalette.red,
		activeFill: tokyonightNightPalette.green,
		activeStroke: tokyonightNightPalette.green,
	},
};
